...
const result1 = weather === "soleado" ? "Me vestiré con un vestido" : "Me vestiré con pantalón";
...
const names1 = ['Rocío', 'Lola', 'Antía', 'Laura', 'Noelia'];
...
console.log(calcularAreaRectangulo(8, 3)); 
console.log(calcularAreaRectangulo(6, 6)); 
